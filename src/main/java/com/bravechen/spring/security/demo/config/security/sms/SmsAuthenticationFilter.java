...
// ~ Static fields/initializers
    ...
    public static final AntPathRequestMatcher MATCHER = new AntPathRequestMatcher("/login", "POST");
    ...
    public SmsAuthenticationFilter() {
        super(request -> MATCHER.matches(request) && StringUtils.isNotBlank(request.getParameter(SPRING_SECURITY_FORM_USERNAME_KEY)));
    }
